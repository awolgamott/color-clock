...
var getColor = function() {
  ...
  var time = new Date() //getting time
  var hours = (time.getHours() / 24) * 255 //put hours to string
  var minutes = (time.getMinutes() / 60) * 255 //put minutes to string
  var seconds = (time.getSeconds() / 60) * 255 //put seconds to string
